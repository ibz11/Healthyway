...
<form action="{{URL('createtimeslot')}}" 
...
<div hidden class="m-2"style="height:5.5em;padding:.2em; margin-top:0;">
<label for="date" style="margin-top:;"class=" text-light form-label"><strong>Therapist_ID</strong> </label>

<input readonly type="text" class="bg-dark text-light form-control w-100" id="name" name="therapist_id">  
</div>



<div class="m-2"style="height:13.5em;padding:.2em; margin-top:0;">
