...
<form action="{{URL('updatetimeslot',$times->time_id)}}" 
...
<input readonly type="text" class="bg-dark text-light form-control w-100" id="name" value="{{Auth::user()->id}}"name="therapist_id">  
</div>



<div class="m-2"style="height:12.5em;padding:.2em; margin-top:0;">
