...
<h1 style="color:white;font-size:40px;"><strong>Hello! <span style="color:aqua;"> </span>. Welcome to the Admin Dashboard</strong></h1>
</div>
<div class="row">
...
<!---Tables-->
<div  style="border-radius:10px;margin:1em;" class="w-75 mt-3 text-light bg-dark table-responsive">
