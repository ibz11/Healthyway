...
<form action="{{URL('admincreatetimeslot', optional($therapist->first())->user_id) }}" 
...
<div class="m-2"style="height:5.5em;padding:.2em; margin-top:0;">
<label for="date" style="margin-top:;"class=" text-light form-label"><strong>Therapist_ID</strong> </label>

<input readonly type="text" class="bg-dark text-light form-control w-100" value="{{ optional($therapist->first())->user_id }}" id="name" name="therapist_id">  
</div>
...
<input type="text" class="bg-dark text-light form-control w-100" id="timeslot" name="timeslot"> 
</div>


<div class="mt-5"style="padding:.5em; margin-top:20em;">
<button type="submit"
style=" background:linear-gradient(to right,#1FA2FF,#0d2f35 ,#155799,#12D8FA);"

class="btn btn-primary"><strong>Create Timeslot</strong></button>
</div>
