...
<div class="modal fade" id="updateModal_{{ $appointment->appointment_id }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="{{URL('adminupdateappointment',$appointment->appointment_id )}}" method="POST" id="editform"enctype="multipart/form-data">
@csrf
...
<input readonly type="text" class="datepicker form-control w-50" id="phone" value="{{$appointment->user_id}}"  name="user_id" required>
</div>
<div  class="mb-3 mt-3">
...
$(document).ready(function() {
        ...
        $('.show').on('click', function() {
            ...
            $.ajax({
                url: '/adminupdateappointment/' + itemId, // Replace with the actual route
                method: 'GET',
