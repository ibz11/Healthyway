...
<div class="d-sm-flex align-items-center justify-content-between  mb-4">
    <h1 class="h3 mb-0 text-gray-800">Hello {{$userdata->full_name}}.Here you can view all Student's Chosen Therapist </h1><br>
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div><a href="{{URL('studentschosentherapist',$user->id)}}" class="btn btn-outline-info"><strong>View {{$user->full_name}}'s Chosen therapist</strong></a>  </div>
                    </div>
                    <div class="col-auto">
